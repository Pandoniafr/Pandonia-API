...
import fr.pandonia.tools.particles.data.color.DustColorTransitionData;
import fr.pandonia.tools.particles.data.color.DustData;
import fr.pandonia.tools.particles.data.color.RegularColor;
import org.bukkit.Bukkit;
import org.bukkit.Location;
import org.bukkit.entity.Player;
import org.bukkit.util.Vector;
import fr.pandonia.tools.particles.data.ParticleData;
import fr.pandonia.tools.particles.data.VibrationData;
import fr.pandonia.tools.particles.data.color.NoteColor;
import fr.pandonia.tools.particles.data.color.ParticleColor;
import fr.pandonia.tools.particles.data.texture.BlockTexture;
import fr.pandonia.tools.particles.data.texture.ItemTexture;
...
import static fr.pandonia.tools.particles.ParticleConstants.PARTICLE_TYPE_REGISTRY;
import static fr.pandonia.tools.particles.ParticleConstants.REGISTRY_GET_METHOD;
import static fr.pandonia.tools.particles.PropertyType.*;
...
public enum ParticleEffect {
     ...
     */
    private final fr.pandonia.tools.particles.PropertyType[] properties;
     ...
     */
    ParticleEffect(IntFunction<String> fieldNameMapper, fr.pandonia.tools.particles.PropertyType... properties) {
     ...
     */
    public boolean hasProperty(fr.pandonia.tools.particles.PropertyType propertyType) {
    ...
    public Object getNMSObject() {
        ...
        if (ReflectionUtils.MINECRAFT_VERSION < 13)
            return Arrays.stream(fr.pandonia.tools.particles.ParticleConstants.PARTICLE_ENUM.getEnumConstants()).filter(effect -> effect.toString().equals(fieldName)).findFirst().orElse(null);
        else try {
    ...
    public void display(Location location, float offsetX, float offsetY, float offsetZ, float speed, int amount, ParticleData data, Collection<? extends Player> players) {
        ...
        if (data != null)
            data.setEffect(this);
        fr.pandonia.tools.particles.ParticlePacket packet = new fr.pandonia.tools.particles.ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, data);
